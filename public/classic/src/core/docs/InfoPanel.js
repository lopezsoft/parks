            ...
            dockedItems: [
                {
                    ...
                    items   : [
                        ...
                        },'-',
                        {
                            ...
                            itemId      : 'deleteButton',
                            handler : function (btn) {
                                btn.up('window').onDelete(btn);
                            }
                        },'-',
                        {
                            iconCls		: 'fas fa-print',
                            tooltip     : 'Guarda el predido y genera el TICKET de venta.',
                            cls         : 'button-print',
                            text        : 'Aceptar',
                            iconAlign	: 'left',
                            // scale       : 'large',
                            handler : function (btn) {
                                btn.up('window').onTiket(btn);
                            }
                        },'-',
                        {
