...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-image: url(&quot;/assets/img/fastfood.jpg?h=97b6bcc31fb7ab63013e874e1b14ca53&quot;);">
        <!-- Start: Team Boxed -->
        <div class="team-boxed">
            <div class="container">
                <!-- Start: Intro -->
                <div class="intro">
                    <h2 class="text-center">MENÚ COMIDAS RÁPIDAS</h2>
                    <p class="text-center">Desde la parte inferior puede ingresar y dar permiso a los clientes al menú de comidas rápidas</p>
                </div>
                <!-- End: Intro -->
                <!-- Start: People -->
                <div class="row people">
                    <div class="col-md-12 col-lg-6 item" style="margin: auto;">
                            ...
                            <form class="login-fast"  method="POST" action="{{ url('/api/auth/login') }}">
                                @csrf
